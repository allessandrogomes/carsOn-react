...
export default function Year() {
  ...
  function updateIntervalYear(intervalType: string, value: string) {
  ...
  function addYearIntervalFilter(
    ...
    <div>
      ...
      <div className="flex">
        {activeFilter ? (
          ...
          <form
            onSubmit={(event) =>
              addYearIntervalFilter(
                event,
                intervalYear.minYear,
                intervalYear.maxYear,
              )
            }
          >
            <div className="flex">
              <Input
                onChange={(event) =>
                  updateIntervalYear('minYear', event.target.value)
                }
                value={intervalYear.minYear}
                h5="ex.: 2010"
                minLength={4}
                maxLength={4}
                placeholder="de"
              ...
              <Input
                onChange={(event) =>
                  updateIntervalYear('maxYear', event.target.value)
                }
                value={intervalYear.maxYear}
                h5="ex.: 2018"
                minLength={4}
                maxLength={4}
                placeholder="ate"
