export default function CardCar({ image, name, price, year, km, city, state }) {
    return (
        <div className="carro w-56 m-1 mb-10">
            ...
            <div className="flex text-left">
                ...
                <div>
                    <h3 className="nomeCarro ml-4 uppercase mb-1 text-base font-archivo font-bold text-color2">{name}</h3>
                    <h4 className="ml-4 mb-1 text-lg font-bold font-big-shoulders-display">R$ {price}</h4>
